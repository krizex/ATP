...
def getDepartureTimeAirport(node):
    ...
    L.debug("%s, %s", depTime, depAirport)
...
def getArriveTimeAirport(node):
    ...
    L.debug("%s, %s", arrTime, arrAirport)
